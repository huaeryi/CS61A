...
class Player:
    def __init__(self, deck, name):
        ...
        self.name = name
        "*** YOUR CODE HERE ***"
        self.hand = [self.deck.cards[i] for i in range(5)]
    ...
    def draw(self):
        ...
        "*** YOUR CODE HERE ***"
        self.hand = self.hand + [self.deck.cards[0]]
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        opponent.hand = opponent.hand[3:] + opponent.deck.cards[:3]
        opponent.deck.cards = opponent.deck.cards[3:]
...
class ProfessorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        co = opponent.deck.cards
        j = 0
        while j < len(co):
            if co[j].attack == opponent_card.attack \
               and co[j].defense == opponent_card.defense:
                co.pop(j)
            else:
                j += 1
